...
IMG ?= registry.cn-hangzhou.aliyuncs.com/hetudb/$(APP_NAME)
TOOL_IMG ?= registry.cn-hangzhou.aliyuncs.com/hetudb/$(APP_NAME)-tools
CLI_IMG ?= registry.cn-hangzhou.aliyuncs.com/hetudb/kbcli
CHARTS_IMG ?= registry.cn-hangzhou.aliyuncs.com/hetudb/$(APP_NAME)-charts
CLI_TAG ?= v$(CLI_VERSION)
DATASCRIPT_IMG ?= registry.cn-hangzhou.aliyuncs.com/hetudb/$(APP_NAME)-datascript
DATAPROTECTION_IMG ?= registry.cn-hangzhou.aliyuncs.com/hetudb/$(APP_NAME)-dataprotection

# Update whenever you upgrade dev container image
DEV_CONTAINER_VERSION_TAG ?= latest
DEV_CONTAINER_IMAGE_NAME = registry.cn-hangzhou.aliyuncs.com/hetudb/$(APP_NAME)-dev
